          ...
          <div className="overflow-x-auto pb-4 scrollbar-thin scrollbar-thumb-cyan-500/50 scrollbar-track-transparent">
            <div className="flex gap-5" style={{ minWidth: 'max-content' }}>
              {brevets.map((b) => {
                ...
                const dayMonth = dateObj ? dateObj.toLocaleDateString(dateLocale, { day: 'numeric', month: 'short' }) : '';
    ...
    <div className="min-h-screen bg-[#0A1628] font-sans">
      ...
      <section className="relative w-full h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          ...
          <div className="inline-block bg-cyan-500/10 border border-cyan-500/30 text-cyan-400 text-xs font-bold px-4 py-2 rounded-full mb-8 tracking-widest backdrop-blur-sm">{t('heroBadge')}</div>
          <h2 className="text-4xl sm:text-6xl font-bold text-white leading-tight mb-6 drop-shadow-lg">{t('heroTitleLine1')}<br /><span className="text-cyan-400">{t('heroTitleLine2')}</span></h2>
          <p className="text-white/70 text-lg max-w-2xl mx-auto mb-12 leading-relaxed drop-shadow">{t('heroSubhead')}</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/brevets" className="bg-cyan-500 hover:bg-cyan-400 text-black font-bold px-8 py-4 rounded-full text-base transition-colors shadow-lg shadow-cyan-500/25">{t('ctaBrevets')}</Link>
            <Link href="/about" className="border border-white/30 hover:border-white/60 text-white px-8 py-4 rounded-full text-base transition-colors backdrop-blur-sm bg-white/5">{t('ctaAbout')}</Link>
          </div>
        </div>
      ...
      <section className="max-w-5xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <Link href="/brevets" className="bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-cyan-500/40 transition-colors"><div className="text-3xl mb-4">📅</div><h3 className="text-white font-bold text-lg mb-2">{t('featureCalendarTitle')}</h3><p className="text-white/50 text-sm leading-relaxed">{t('featureCalendarDesc')}</p><div className="mt-4 text-cyan-400 text-xs font-bold tracking-wider">{t('seeHere')}</div></Link>
          <Link href="/live" className="bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-cyan-500/40 transition-colors"><div className="text-3xl mb-4">🗺️</div><h3 className="text-white font-bold text-lg mb-2">{t('featureLiveTitle')}</h3><p className="text-white/50 text-sm leading-relaxed">{t('featureLiveDesc')}</p><div className="mt-4 text-cyan-400 text-xs font-bold tracking-wider">{t('seeHere')}</div></Link>
          <Link href="/members" className="bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-cyan-500/40 transition-colors"><div className="text-3xl mb-4">🏆</div><h3 className="text-white font-bold text-lg mb-2">{t('featureHistoryTitle')}</h3><p className="text-white/50 text-sm leading-relaxed">{t('featureHistoryDesc')}</p><div className="mt-4 text-cyan-400 text-xs font-bold tracking-wider">{t('comingSoon')}</div></Link>
        </div>
      </section>
      ...
      <section className="border-t border-white/10">
        <div className="max-w-5xl mx-auto px-6 py-12">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 text-center">
            <div><div className="text-3xl font-bold text-cyan-400">20+</div><div className="text-white/50 text-sm mt-1">{t('statsYears')}</div></div>
            <div><div className="text-3xl font-bold text-cyan-400">500+</div><div className="text-white/50 text-sm mt-1">{t('statsRiders')}</div></div>
            <div><div className="text-3xl font-bold text-cyan-400">1000+</div><div className="text-white/50 text-sm mt-1">{t('statsBrevets')}</div></div>
            <div><div className="text-3xl font-bold text-cyan-400">10</div><div className="text-white/50 text-sm mt-1">{t('statsOrganizers')}</div></div>
          </div>
        </div>
      </section>
