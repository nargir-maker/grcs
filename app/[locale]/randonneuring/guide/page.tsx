...
const CLUBS = [
  ...
  },
  {
    ...
    dot:     'bg-blue-400',
    body:    'Με έδρα την Αθήνα (ίδρυση 2012), μία από τις πιο ενεργές παρέες του χώρου. Εισήγαγαν τον θεσμό των Permanents (μόνιμες διαδρομές που τρέχεις οποιαδήποτε μέρα) και διοργανώνουν δημοφιλή brevets σε όλη την Ελλάδα.',
  },
  {
    name:    'Π.Ε.Π.Α.',
    site:    'pepa.gr',
    ...
    <div className="min-h-screen bg-[#0A1628] px-4 py-12">
      <div className="max-w-3xl mx-auto">
        ...
        <section className="mb-12">
          <SectionTitle emoji="🩺">Ιατρικός Έλεγχος πριν Ξεκινήσεις</SectionTitle>
          <Card>
            <p className="text-white/70 text-sm leading-relaxed mb-4">
              Πριν επενδύσεις σε εξοπλισμό ή σχεδιάσεις προπονήσεις, βεβαιώσου ότι το σώμα
              σου είναι έτοιμο για τη φύση αυτού του αθλήματος: πολύωρη, συνεχόμενη
              προσπάθεια, συχνά σε αντίξοες καιρικές συνθήκες (καύσωνας, κρύο, βροχή) και
              σε ώρες που κανονικά θα κοιμόσουν.
            </p>
            <Tip>
              <strong className="text-white/90">Καρδιολογικός έλεγχος μία φορά τον χρόνο.</strong>{' '}
              Ένα τεστ κοπώσεως με καρδιολόγο είναι το ελάχιστο που χρειάζεσαι πριν
              υποβάλεις την καρδιά σου σε τόσο παρατεταμένη προσπάθεια. Δεν αφορά μόνο
              αναβάτες μεγαλύτερης ηλικίας — αθόρυβα καρδιακά προβλήματα μπορεί να
              υπάρχουν σε οποιαδήποτε ηλικία χωρίς ποτέ να φανούν στις καθημερινές
              δραστηριότητες.
            </Tip>
            <p className="text-white/60 text-sm leading-relaxed mt-4">
              Αυτό γίνεται ακόμα πιο κρίσιμο όσο ανεβαίνεις σε απόσταση (300, 400, 600
              χλμ), όπου το σώμα λειτουργεί για πολλές ώρες υπό στρες, με έλλειψη ύπνου και
              συχνά ακραίες θερμοκρασίες. Μη θεωρείς δεδομένη την καλή φυσική σου
              κατάσταση — ζήτα ετήσια ιατρική γνωμάτευση.
            </p>
          </Card>
        </section>
        ...
        <section className="mb-12">
          ...
          <Card>
            ...
            <BulletList items={[
              ...
              {
                label: 'Κρέμα Chamois:',
                body: 'Απαραίτητη για την πρόληψη τριβών και συγκαμάτων μετά από ώρες στη σέλα. Εφαρμόζεται πριν φορέσεις το κολάν.',
              },
              {
                label: 'Χωρίς εσώρουχο:',
                body: 'Το κολάν φοριέται πάντα χωρίς εσώρουχο από κάτω. Το chamois είναι σχεδιασμένο να απομακρύνει την υγρασία από το δέρμα, ενώ ένα εσώρουχο την παγιδεύει και προσθέτει ραφές — και τα δύο αυξάνουν τον κίνδυνο συγκαμάτων.',
              },
              {
            ...
            <div className="space-y-4">
              {[
                ...
                },
                {
                  ...
                  body: 'Μην σκέφτεσαι «έχω ακόμα 150 χλμ». Σκέψου «έχω 30 χλμ μέχρι το επόμενο control, εκεί θα φάω μια μπανάνα». Η ψυχολογία είναι ο παράγοντας που κερδίζει την κόπωση.',
                },
              ].map((s) => (
