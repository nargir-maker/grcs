...
const CHANGES = [
  {
    date: 'Αυγ 2026',
    items: [
      '🔗 Νέα ενότητα "Θέλω Περισσότερο Ποδήλατο" στην αρχική — κυλιόμενη λωρίδα με λογότυπα και συνδέσμους προς φορείς & συλλόγους, με εφέ αστεριών που τρεμοπαίζουν στο φόντο',
      '🖼️ Ενημερώθηκαν όλες οι εικόνες στις κάρτες των brevets',
      '✨ Οι κάρτες brevets μεγαλώνουν και «φωτίζονται» στο πέρασμα του ποντικιού',
      '📲 Απευθείας σύνδεσμος λήψης από το Google Play στη σελίδα "Σχετικά"',
      '🏅 Λογότυπα ΛΕ.ΠΟ.Τ.Ε. & H.A.R. με συνδέσμους στη σελίδα "Σχετικά"',
      '🎬 Τα βίντεο στη σελίδα "Σχετικά" παίζουν πλέον σε συνεχή επανάληψη',
    ],
  },
  {
    date: 'Ιούλ 2026',
    items: [
      '🗺️ Νέα σελίδα "Χάρτης Διαδρομών" — όλες οι διαδρομές του 2026 σε έναν χάρτη, χρωματισμένες ανά απόσταση, με πλήρη οθόνη και φίλτρο ΛΕ.ΠΟ.Τ.Ε. / HAR',
      '🌙 Ένδειξη φεγγαριού για νυχτερινή εκκίνηση + σύνολο ωρών σκότους σε πολυήμερα brevets',
      '🌧️ Ενδείξεις βροχής στον χάρτη διαδρομής + πηγή πρόγνωσης καιρού (MET Norway / Open-Meteo)',
      '📖 Νέα ενότητα "Randonneuring" — ιστορία & δομή του αθλήματος και πρακτικός οδηγός για αρχάριους',
      '✏️ Διοργανωτές & Admin μπορούν πλέον να επεξεργάζονται υπάρχοντα brevets',
      '🔗 Εξωτερικοί σύνδεσμοι εγγραφής ανά brevet (ανακατεύθυνση σε εξωτερική πλατφόρμα)',
      '📋 Ιστορικό Brevets πλέον δημόσιο — δεν απαιτείται σύνδεση',
      '🧭 Νέο dropdown μενού πλοήγησης — Brevets, Στατιστικά, Randonneuring',
    ],
  },
  {
    date: 'Ιούν 2026',
